          ...
          if (status === 200 || status === 201) {
            if (body.error && body.error.message) {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadot_errorconfirm_alertbtn"
                },
                icon: 'error',
            })
            } else {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadot_success_confirm_alertbtn"
                },
                icon: 'success',
            })
            }
            ...
            ErrorSwal.fire({
              ...
              didOpen: () => {
                ...
                if(confirmButton)
                  confirmButton.id = "squadot_errorconfirm2_alertbtn"
              },
              icon: 'error',
          })
          }
          ...
          if (status === 200 || status === 201) {
            if (body.error && body.error.message) {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadot_errorconfirm3_alertbtn"
                },
                icon: 'error',
            })
            } else {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadot_successconfirm2_alertbtn"
                },
                icon: 'success',
            })
              getMyOT(0, key)
            ...
            ErrorSwal.fire({
              ...
              didOpen: () => {
                ...
                if(confirmButton)
                  confirmButton.id = "squadot_errorconfirm4_alertbtn"
              },
              icon: 'error',
          })
          }
          ...
          if (status === 200 || status === 201) {
            if (body.error && body.error.message) {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadot_errorconfirm5_alertbtn"
                },
                icon: 'error',
            })
            } else {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadot_successconfirm3_alertbtn"
                },
                icon: 'success',
            })
            }
            ...
            ErrorSwal.fire({
              ...
              didOpen: () => {
                ...
                if(confirmButton)
                  confirmButton.id = "squadot_errorconfirm6_alertbtn"
              },
              icon: 'error',
          })
          }
