          ...
          if (status === 200 || status === 201) {
            if (body.error && body.error.message) {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadadj_errorconfirm_alertbtn"
                },
                icon: 'error',
            })
            } else {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadadj_successconfirm_alertbtn"
                },
                icon: 'success',
            })
              getAllAdjustments(0, key)
            ...
            ErrorSwal.fire({
              ...
              didOpen: () => {
                ...
                if(confirmButton)
                  confirmButton.id = "squadadj_errorconfirm2_alertbtn"
              },
              icon: 'error',
          })
          }
          ...
          if (status === 200 || status === 201) {
            if (body.error && body.error.message) {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadadj_errorconfirm3_alertbtn"
                },
                icon: 'error',
            })
            } else {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadadj_successconfirm2_alertbtn"
                },
                icon: 'success',
            })
              getAllAdjustments(0, key)
            ...
            ErrorSwal.fire({
              ...
              didOpen: () => {
                ...
                if(confirmButton)
                  confirmButton.id = "squadadj_errorconfirm4_alertbtn"
              },
              icon: 'error',
          })
          }
          ...
          if (status === 200 || status === 201) {
            if (body.error && body.error.message) {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadadj_errorconfirm5_alertbtn"
                },
                icon: 'error',
            })
            } else {
              ...
              ErrorSwal.fire({
                ...
                didOpen: () => {
                  ...
                  if(confirmButton)
                    confirmButton.id = "squadadj_successconfirm3_alertbtn"
                },
                icon: 'success',
            })
              getAllAdjustments(0, key)
            ...
            ErrorSwal.fire({
              ...
              didOpen: () => {
                ...
                if(confirmButton)
                  confirmButton.id = "squadadj_errorconfirm6_alertbtn"
              },
              icon: 'error',
          })
          }
