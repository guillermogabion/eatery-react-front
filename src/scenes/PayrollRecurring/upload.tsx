...
const Upload: React.FC<FileUploadProps> = ({ onCloseModal }) => {
  ...
  return (
    <div className="form-group">
      <input id="payrollrecurringupload_file_input" type="file" accept=".xlsx" className="file-input-style" onChange={handleFileChange} />
      <button id="payrollrecurringupload_upload_btn" className="btn btn-primary" onClick={upload}>Upload</button>
    </div>
  );
};
