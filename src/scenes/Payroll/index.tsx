                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-3 mb-3 mt-4">
                                            ...
                                            <option value="" disabled selected>
                                                ...
                                                {adjustmentTypes &&
                                                adjustmentTypes.content &&
                                                adjustmentTypes.content.length &&
                                                adjustmentTypes.content.map((item: any, index: string) => (
                                                    <option key={`${index}_${item.adjustmentTypeId}`} value={item.deduction}>
                                                    {item.adjustmentName}
                                                    </option>
                                                ))}
                                            </select>
